...
import org.jason.yeeyi.datamodel.RentRecordDO;
...
public final class YeeyiHelper {
    ...
    private static final Logger logger = LogManager.getLogger(YeeyiHelper.class);
