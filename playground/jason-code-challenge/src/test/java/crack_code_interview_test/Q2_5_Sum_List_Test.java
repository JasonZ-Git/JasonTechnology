...
public class Q2_5_Sum_List_Test {
  ...
  public void testSumList() {
    ...
    Assertions.assertEquals(result.getNext().getData(), 2);
    Assertions.assertEquals(result.getNext().getNext().getData(), 1);
    Assertions.assertEquals(result.getNext().getNext().getNext().getData(), 9);
  }
}
